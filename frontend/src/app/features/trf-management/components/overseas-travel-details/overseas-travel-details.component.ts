...
@Component({
  ...
  imports: [
    ...
    ItineraryEditorComponent,
    AdvanceAmountEditorComponent,
  ],
  templateUrl: './overseas-travel-details.component.html',
  styleUrls: ['./overseas-travel-details.component.scss'],
})
export class OverseasTravelDetailsComponent implements OnInit, OnChanges, OnDestroy {
  ...
  advanceAmounts: Record<string, unknown>[] = [];
  ...
  onAdvanceAmountsChange(items: Record<string, unknown>[]): void {
  ...
  isValid(): boolean {
    return (
      this.overseasForm.valid &&
      this.advanceAmountEditorValid &&
