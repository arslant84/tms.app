...
class Migration(migrations.Migration):
    ...
    operations = [
        # Delete the old model from migration 0002 before recreating it below -
        # this migration's fields/db_table are entirely different, and without
        # this the orphaned 0002 table collides with 0005's later
        # AlterModelTable(table=None), which renames this migration's table
        # back onto the (still-existing) old table name.
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                "step_created",
                                "When Step is Created (Approval Requested)",
                            ),
                        ...
                        help_text="Event that triggers this notification",
                        max_length=50,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("previous_approvers", "All Previous Approvers"),
                            ("role", "Specific Role(s)"),
                            ("user", "Specific User(s)"),
                            ("department_head", "Department Head"),
                            ("all_approvers", "All Approvers in Workflow"),
                        ],
                        default="approver",
                        help_text="Who should receive this notification (TO field)",
                        max_length=50,
                    ),
                ),
                (
                    "cc_requestor",
                    models.BooleanField(
                        default=False, help_text="CC the original requestor"
                    ),
                ),
                (
                    "cc_previous_approvers",
                    models.BooleanField(
                        default=False,
                ...
                (
                    "cc_next_approver",
                    models.BooleanField(
                        default=False, help_text="CC the next approver in workflow"
                    ),
                ),
                (
                    "send_in_app",
                    models.BooleanField(
                        default=True, help_text="Send as in-app notification"
                    ),
                ),
                (
                    "send_email",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Send as push notification (future feature)",
                    ),
                ),
                (
                    "custom_subject",
                    models.CharField(
                        blank=True,
                        help_text="Custom email subject (optional, overrides template)",
                        max_length=500,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Custom email message (optional, overrides template)",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="created_workflow_notification_configs",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Email template to use (optional, uses default if not set)",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        related_name="workflow_notification_to",
                        to="accounts.role",
                    ),
                ),
                (
                ...
                (
                    "workflow_step",
                    models.ForeignKey(
                        help_text="Workflow step this notification configuration applies to",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["workflow_step", "trigger_event", "is_active"],
                        name="workflow_st_workflo_9067f0_idx",
                    ),
                    models.Index(
                        fields=["is_active"], name="workflow_st_is_acti_1ac893_idx"
                    ),
                ],
            },
        ),
