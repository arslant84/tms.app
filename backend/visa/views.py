...
class VisaApplicationViewSet(viewsets.ModelViewSet):
    ...
    def export_pdf(self, request, pk=None):
        ...
        tracking_data = [
            ...
            ['Created', visa.created_at.strftime('%Y-%m-%d %H:%M') if visa.created_at else 'Not available'],
            ['Submitted', visa.submitted_date.strftime('%Y-%m-%d %H:%M') if visa.submitted_date else 'Not submitted'],
            ['Processing Started', visa.processing_started_at.strftime('%Y-%m-%d %H:%M') if visa.processing_started_at else 'Not started'],
            ['Processing Completed', visa.processing_completed_at.strftime('%Y-%m-%d %H:%M') if visa.processing_completed_at else 'Not completed'],
            ['Last Updated', visa.updated_at.strftime('%Y-%m-%d %H:%M') if visa.updated_at else 'Not available'],
        ]
        ...
        travel_data = [
            ...
            ['Trip Start Date', visa.trip_start_date.strftime('%Y-%m-%d') if visa.trip_start_date else '-'],
            ['Trip End Date', visa.trip_end_date.strftime('%Y-%m-%d') if visa.trip_end_date else '-'],
            ['Approximate Arrival', visa.approximately_arrival_date.strftime('%Y-%m-%d') if visa.approximately_arrival_date else '-'],
        ...
        passport_data = [
            ...
            ['Date of Issuance', visa.passport_date_of_issuance.strftime('%Y-%m-%d') if visa.passport_date_of_issuance else '-'],
            ['Place of Issuance', visa.passport_place_of_issuance or '-'],
            ['Expiry Date', visa.passport_expiry_date.strftime('%Y-%m-%d') if visa.passport_expiry_date else '-'],
        ]
        ...
        personal_data = [
            ['Field', 'Value'],
            ['Date of Birth', visa.date_of_birth.strftime('%Y-%m-%d') if visa.date_of_birth else '-'],
