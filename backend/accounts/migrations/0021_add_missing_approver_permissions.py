...
def add_missing_permissions(apps, schema_editor):
    ...
    with connection.cursor() as cursor:
        ...
        hod_perms = BASIC_PERMS + CREATE_PERMS + APPROVE_PERMS + [
        ...
        accommodation_admin_perms = BASIC_PERMS + CREATE_PERMS + [
        ...
        transport_admin_perms = BASIC_PERMS + CREATE_PERMS + [
        ...
        visa_clerk_perms = BASIC_PERMS + CREATE_PERMS + [
        ...
        ticketing_admin_perms = BASIC_PERMS + CREATE_PERMS + [
