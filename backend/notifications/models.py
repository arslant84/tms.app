...
class NotificationEventType(models.Model):
    ...
    category = models.CharField(
        max_length=50, help_text="Category: approval, status_update, reminder, system"
    )
...
class NotificationTemplate(models.Model):
    ...
    name = models.CharField(
        max_length=255, unique=True, help_text="Unique template name identifier"
    )

    description = models.TextField(
        blank=True, null=True, help_text="Template description and purpose"
    )
    ...
    notification_type = models.CharField(
        max_length=50, default="email", help_text="Type: email, system, or both"
    )
...
class UserNotificationSubscription(models.Model):
    ...
    event_type = models.ForeignKey(
        NotificationEventType, on_delete=models.CASCADE, related_name="subscriptions"
    )
...
class UserNotification(models.Model):
    ...
    # Issue 14): several entities this can point to use bigint PKs, which a
    # 32-bit PositiveIntegerField would silently wrap/fail on once one
    # exceeds ~2.1 billion.
    ...
    action_text = models.CharField(
        max_length=100, default="View", help_text="Text for the action button"
    )
    ...
    additional_data = models.JSONField(
        blank=True, null=True, help_text="Additional context data for the notification"
    )
