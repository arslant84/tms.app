...
class TestBulkApprovalEndpoint:
    ...
    def test_bulk_approve_no_items(self, authenticated_client):
        ...
        response = authenticated_client.post('/api/admin/approvals/bulk/', {
            'items': [],
            'action': 'approve'
        }, format='json')
    ...
    def test_bulk_approve_unauthenticated(self, api_client):
        ...
        response = api_client.post('/api/admin/approvals/bulk/', {
            'items': [{'id': '1', 'type': 'trf'}],
            'action': 'approve'
        }, format='json')
...
class TestReportsEndpoints:
    ...
    def test_financial_reports(self, admin_client):
        """Test financial reports endpoint."""
        response = admin_client.get('/api/reports/financial/')
